...
Input: Area and Perimeter of the square formula (Take area as area and side as side)

Output: Valid keyword : doubleValid Identifier : areaValid
        operator: =Valid Identifier : sideValid operator: *Valid
        Identifier : sideValid keyword : doubleValid Identifier : 
        perimterValid operator: =Valid Integer : 4Valid operator:
        *Valid Identifier : side
*/
...
int main()
{
    ...
    char str[100] = "double area=side*side; double perimter=4*side; ";
